package com.deathbykoopa.netherspawn;
...
public class SpawnHelper
{
    public static void respawnInNether(Entity player)
    {
        ...
        if (player.world instanceof ServerWorld)
        {
            ...
            RegistryKey<World> registrykey = player.world.func_234923_W_() == World.field_234919_h_ ? World.field_234918_g_ : World.field_234919_h_;
            ...
            if (nether != null && minecraftserver.getAllowNether() && !player.isPassenger())
            {
                ...
                serverPlayer.teleport(nether, spawnPos.getX(), spawnPos.getY(), spawnPos.getZ(), player.getYaw(0.0f), player.getPitch(0.0f));
    ...
    public static BlockPos getSafeSpawn(Entity entityIn, ServerWorld world)
    {
        ...
        for (int j2 = xPos - 16; j2 <= xPos + 16; ++j2)
        {
            ...
            for (int l2 = zPos - 16; l2 <= zPos + 16; ++l2)
            {
                ...
                label276:
                for (int j3 = world.func_234938_ad_() - 1; j3 >= 0; --j3)
                {
                            ...
                            for (int j4 = 0; j4 < 3; ++j4)
                            {
                                for (int k4 = 0; k4 < 4; ++k4)
                                {
                                    for (int l4 = -1; l4 < 4; ++l4)
                                    {
                                        ...
                                        if (l4 < 0 && !world.getBlockState(blockPosMutable).getMaterial().isSolid() || l4 >= 0 && !world.isAirBlock(blockPosMutable))
                                        {
                                            continue label276;
                                        }
                                    }
        ...
        if (d0 < 0.0D)
        {
            for (int l5 = xPos - 16; l5 <= xPos + 16; ++l5)
            {
                ...
                for (int j6 = zPos - 16; j6 <= zPos + 16; ++j6)
                {
                    ...
                    label214:
                    for (int i7 = world.func_234938_ad_() - 1; i7 >= 0; --i7)
                    {
                            ...
                            for (int l7 = i2; l7 < i2 + 2; ++l7)
                            {
                                ...
                                for (int i10 = 0; i10 < 4; ++i10)
                                {
                                    for (int k10 = -1; k10 < 4; ++k10)
                                    {
                                        ...
                                        if (k10 < 0 && !world.getBlockState(blockPosMutable).getMaterial().isSolid() || k10 >= 0 && !world.isAirBlock(blockPosMutable))
                                        {
                                            continue label214;
                                        }
                                    }
            ...
            for (int j7 = -1; j7 <= 1; ++j7)
            {
                for (int i8 = 1; i8 < 3; ++i8)
                {
                    for (int i9 = -1; i9 < 3; ++i9)
                    {
                        ...
                        world.setBlockState(blockPosMutable, flag ? Blocks.OBSIDIAN.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
        }
